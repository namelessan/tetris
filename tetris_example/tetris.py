...
def draw_status_window(window):
    ...
    window.addstr(1, 2, "Score: {}".format(game_board.score))
    window.addstr(2, 2, "Lines: {}".format(game_board.lines))
    window.addstr(3, 2, "Level: {}".format(game_board.level))
    window.addstr(4, 2, "Best Score:{}".format(game_board.best_score))
...
def draw_footer():
    ...
    window.addstr(0, col_pos + len(title) + 1, "<3", curses.color_pair(97))
